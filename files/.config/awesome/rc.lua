...
-- Wallpaper path
local wallpaper = "/home/appu/Pictures/backgrounds/Mountains/geoffrey-price-8CuVNSQ3RS4-unsplash.jpg"
beautiful.get().wallpaper = wallpaper
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "main", "www", "office", "str", "int" }
    local l = awful.layout .suit
    local layouts = { l.tile.left, l.tile.left, l.tile.left, l.floating, l.floating }
...
globalkeys = gears.table.join(
    ...
    --           {description = "swap with next client by index", group = "tag"}),
    -- awful.key({ modkey, "Shift" }, "Right", function () awful.client.swap.byidx( -1) end,
    --           {description = "swap with previous client by index", group = "tag"}),
    awful.key({ modkey, "Control" }, "j", function () awful.client.swap.byidx(  1)     end,
              {description = "swap with next client by index", group = "client"}),
    awful.key({ modkey, "Control" }, "k", function () awful.client.swap.byidx( -1)     end,
              {description = "swap with previous client by index", group = "client"}),
    awful.key({ modkey, "Shift"   }, "k", function () awful.screen.focus_relative(1)   end,
              {description = "Toggle focused screen", group = "screen"}), -- If there are only 2 screens
    ...
    awful.key({ modkey,           }, "f", function () awful.spawn("firefox") end,
              {description = "Open the Firefox web browser", group = "programs"}),
    awful.key({ modkey,           }, "v", function () awful.spawn("code") end,
              {description = "Open Visual Studio Code", group = "programs"}),
...
-- Autostart
-- {{{
awful.spawn("noisetorch -i")
awful.spawn("discord")
awful.spawn.with_shell("~/.screenlayout/enable_second_monitor.sh")
awful.spawn("~/.screenlayout/mouse-speed.sh")
-- }}}
